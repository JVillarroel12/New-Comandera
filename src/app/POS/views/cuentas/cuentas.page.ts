...
import { ModalAddReservaPage } from '../../modals/modal-add-reserva/modal-add-reserva.page';
import { ModalCuentasPage } from '../../modals/modal-cuentas/modal-cuentas.page';
import { ModalPreciosPage } from '../../modals/modal-precios/modal-precios.page';
import { ModalSepararPage } from '../../modals/modal-separar/modal-separar.page';
import { ModalTransladarCuentaPage } from '../../modals/modal-transladar-cuenta/modal-transladar-cuenta.page';
import { ApiServiceService } from '../../../services/api-service.service';
import { ModalListReservacionesPage } from '../../modals/modal-list-reservaciones/modal-list-reservaciones.page';
import { ModalFacturacionPage } from '../../modals/modal-facturacion/modal-facturacion.page';
import { ModalRrppPage } from '../../modals/modal-rrpp/modal-rrpp.page';
import { ModalClaveUsuarioPage } from '../../modals/modal-clave-usuario/modal-clave-usuario.page';
...
export class CuentasPage implements OnInit {
  ...
  seleccionarCuentas(event, _data) {
    if (event.detail.checked == true) {
      ...
      this.desseleccionarCuentas(this.cuentasSeleccionadas, _data);
    }
  }
  /** FUNCION PARA QUITAR UNA CUENTA SELECCIONADA DEL ARRAY QUE SE ENVIARA PARA UNIRLAS**/
  desseleccionarCuentas(listaCuentas, cuenta) {
    let lista = [];
    let lista2 = [];
