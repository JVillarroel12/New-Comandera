...
import { ModalAnularFacturaPage } from '../modal-anular-factura/modal-anular-factura.page';
import { ModalFacturacionPage } from '../modal-facturacion/modal-facturacion.page';
import { ModalGenerarReporteReservacionesPage } from '../modal-generar-reporte-reservaciones/modal-generar-reporte-reservaciones.page';
import { ModalListReservacionesGlobalesPage } from '../modal-list-reservaciones-globales/modal-list-reservaciones-globales.page';
import { ModalPreciosPage } from '../modal-precios/modal-precios.page';
import { ModalReservarZonasMesasPage } from '../modal-reservar-zonas-mesas/modal-reservar-zonas-mesas.page';
